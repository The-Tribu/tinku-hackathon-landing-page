...
- **Una URL pública en producción**

---

# Despliegue obligatorio

Todos los proyectos deben estar desplegados en un entorno de producción accesible por una **URL pública**.
...
La URL debe incluirse en la entrega final.

---

# Originalidad del proyecto

Queremos ideas frescas.
...
¿Resuelve un problema real de forma diferente?
...
¿Puede convertirse en un producto real?
...
## ¿Quién puede asistir y cuánto cuesta?

El evento tiene dos roles.

**Visitantes**

Entrada gratuita registrándose previamente.
...
Si ocurre un imprevisto, el equipo puede competir con:

- mínimo **2 integrantes**
- o incluso **1 integrante**
...
Puedes traer snacks si lo deseas.
...
## ¿Puedo traer código ya desarrollado?
...
La propiedad intelectual pertenece **100% a tu equipo**.

Solo se pide que el código sea público con **licencia MIT**.

---

# Actividades adicionales

Además de programar, el evento incluirá:

🎮 torneos de videojuegos  
🎪 exhibiciones  
🎲 minijuegos organizados por el equipo y patrocinadores  
